...
import img2 from '../../assets/Images/pexels-jonathanschmer-2452241.jpg';
import img3 from '../../assets/Images/pexels-ignacio-pales-407380-2900786.jpg';
import img4 from '../../assets/Images/pexels-oidonnyboy-5345858.jpg';
import img5 from '../../assets/Images/pexels-josh-willink-11499-58572.jpg';
import img6 from '../../assets/Images/pexels-vinicius-maciel-1820405-3434562.jpg';
import malibu from '../../assets/Images/pexels-pixabay-161764.jpg';
import { FaRegClock, FaUsers, FaMapMarkedAlt, FaGlobe } from 'react-icons/fa';
import axios from 'axios';

const californiaImages = [img1, img2, img3, img4, img5, img6];
const mainCaliforniaImage = malibu;

const TourDetailCalifornia = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const bookingData = {
        tourTitle: 'California Sunset Cruise',
        ...formData,
  ...
  return (
    <div className="tour-detail-container" style={{padding: '2rem', background: '#f8f9fa'}}>
        ...
        <div style={{flex: 2}}>
          <div style={{background: '#fff', borderRadius: '10px', padding: '1.5rem', marginBottom: '1.5rem', boxShadow: '0 2px 8px #eee'}}>
            ...
            <p style={{fontSize: '1.1rem', color: '#333', marginTop: '1rem'}}>
              Experience the magic of California's coastline! From the iconic Golden Gate Bridge in San Francisco to the glamorous beaches of Los Angeles, this 3-day adventure offers breathtaking ocean views, world-class cuisine, and unforgettable sunsets. Whether you're seeking relaxation or adventure, the Golden State welcomes you with open arms and endless sunshine.
            </p>
          </div>
          <div style={{background: '#fff', borderRadius: '10px', padding: '1.5rem', boxShadow: '0 2px 8px #eee', marginBottom: '1.5rem'}}>
            ...
            <ul style={{fontSize: '1.05rem', color: '#333', marginTop: '1rem', paddingLeft: '1.2rem'}}>
              <li>Sunset cruise along the Pacific Coast</li>
              <li>Visit to Malibu's famous beaches</li>
              <li>Wine tasting in Santa Barbara</li>
              <li>Coastal hiking with ocean views</li>
              <li>Fresh seafood dining experience</li>
              <li>Optional whale watching tour</li>
            </ul>
          </div>
          {/* Accordion Sections */}
                ...
                <div style={{display: 'flex', gap: '2rem', padding: '0 1.5rem 1.2rem 1.5rem'}}>
                  <div style={{flex: 1}}>
                    ...
                    <ul style={{marginTop: 8, marginBottom: 0, paddingLeft: 18}}>
                      ...
                      <li>Guided coastal walks</li>
                      <li>Sunset cruise tickets</li>
                    </ul>
                  </div>
                  <div style={{flex: 1}}>
                    <b>Excluded:</b>
                    <ul style={{marginTop: 8, marginBottom: 0, paddingLeft: 18}}>
                      <li>Flights to/from California</li>
      ...
      <div style={{
        ...
        gap: '2.5rem',
        flexWrap: 'wrap',
        background: `linear-gradient(120deg, rgba(0,123,255,0.60) 0%, rgba(0,86,179,0.45) 100%), url(${mainCaliforniaImage}) center/cover no-repeat`
      }}>
        {/* Overlay */}
        <div style={{
          position: 'absolute',
        ...
        <div style={{flex: 1, minWidth: 320, position: 'relative', zIndex: 2}}>
          <h1 style={{fontSize: '2.7rem', fontWeight: 'bold', color: '#fff', margin: 0, textShadow: '0 2px 12px rgba(0,0,0,0.3)'}}>Find Your California Guide</h1>
        </div>
        <div style={{flex: 2, minWidth: 320, maxWidth: 600, position: 'relative', zIndex: 2}}>
          <h2 style={{fontWeight: 'bold', color: '#fff', fontSize: '1.45rem', marginBottom: 10, textShadow: '0 2px 8px rgba(0,0,0,0.2)'}}>Certified by the California Tourism Board</h2>
          <p style={{fontSize: '1.13rem', color: '#fff', margin: '14px 0 0 0', textShadow: '0 1px 8px rgba(0,0,0,0.2)'}}>Explore California with a certified local guide. Discover hidden beaches, scenic coastal trails, and experience the best of the Golden State.</p>
          <p style={{fontSize: '1.13rem', color: '#fff', margin: '14px 0', textShadow: '0 1px 8px rgba(0,0,0,0.2)'}}>Choose from passionate guides who know the best spots for coastal adventures, wine tasting, and local culture.</p>
...
export default TourDetailCalifornia; 